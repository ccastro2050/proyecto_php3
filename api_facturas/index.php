<?php
/**
 * index.php — el FRONT CONTROLLER de la API Facturas v3.
 *
 * ESTE ARCHIVO NO CAMBIÓ AL AGREGAR EL SEGUNDO MOTOR, salvo la línea que
 * publica cuál está activo en el diagnóstico. Las seis rutas, los seis
 * controladores y los 405 son exactamente los de la v2 — y que sea así es
 * medio examen de esta versión.
 *
 * TODAS las peticiones entran por aquí (el servidor se arranca con
 * `php -S 0.0.0.0:8086 index.php`). Este archivo hace UNA cosa: mirar el
...
if ($ruta === '/' && $metodo === 'GET') {
    echo json_encode([
        ...
        // explicar para qué: la v3 promete que el sistema se comporta igual
        // contra los dos motores, y una promesa así hay que poder
        // COMPROBARLA. Sin este dato, la única forma de saber contra cuál
        // está corriendo la API sería mirar el compose.
        //
        ...
        'contratos' => 'docs/spec_kit/versiones/v3_segundo_motor/6_contracts.md',
