    ...
    <div class="container">
      <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
        <p class="text-body-secondary small mb-0">
          ...
          versión 3: el mismo sistema contra dos motores
        </p>
        ...
        <?php /* ==============================================================
             ...
             Se muestra porque la versión 3 promete que todo funciona igual
             contra los dos motores, y una promesa así hay que poder
             comprobarla: cambie `MOTOR` en el compose, refresque, y verá
             cambiar esta etiqueta **y nada más**.
             ============================================================== */ ?>
        <?php if (!empty($motor)): ?>
          <span class="badge text-bg-light border font-monospace" title="El motor de base de datos que está usando la API">
            <?= htmlspecialchars($motor === 'postgres' ? 'PostgreSQL' : 'MariaDB') ?>
          </span>
        <?php endif; ?>
      </div>
    </div>
